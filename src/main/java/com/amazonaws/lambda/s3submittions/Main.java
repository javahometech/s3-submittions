...
//		}
	...
	private static void addOfferingLevel(Connection con, OfferingData data, String offeringId) throws SQLException {
		...
		pstmt.setString(2, data.getOffering().getAction());
		pstmt.setString(3, data.getOffering().getLegalDs());
		pstmt.executeUpdate();
	}
	
	private static void addIssuesLevel(Connection con, OfferingData data, String offeringId) throws SQLException {
		PreparedStatement pstmt = con.prepareStatement(issuesLevel);
		pstmt.setString(1, offeringId);
		pstmt.setString(2, data.getIssues().get(0).getAction());
		pstmt.setString(3, data.getIssues().get(0).getBaseQsip());
		pstmt.setString(4, data.getIssues().get(0).getXpctdClsgDt());
		pstmt.executeUpdate();
	}
	
	private static void addIssuesSecuritiesLevel(Connection con, OfferingData data, String offeringId) throws SQLException {
		PreparedStatement pstmt = con.prepareStatement(issuesSecuritiesLevel);
		pstmt.setString(1, offeringId);
		pstmt.setString(2, data.getIssues().get(0).getSecurities().get(0).getAction());
		pstmt.setString(3, data.getIssues().get(0).getSecurities().get(0).getSecId());
		pstmt.setString(4, data.getIssues().get(0).getSecurities().get(0).getMaturityDt());
		pstmt.setString(5, data.getIssues().get(0).getSecurities().get(0).getDatedDt());
		pstmt.setDouble(6, data.getIssues().get(0).getSecurities().get(0).getIntRt());
		pstmt.executeUpdate();
	}
	
	private static void addIssuesSecUndrtLevel(Connection con, OfferingData data, String offeringId) throws SQLException {
		PreparedStatement pstmt = con.prepareStatement(issuesSecUndrtLevel);
		pstmt.setString(1, offeringId);
		pstmt.setString(2, data.getIssues().get(0).getSecurities().get(0).getSecUndrt().get(0).getAction());
		pstmt.setString(3, data.getIssues().get(0).getSecurities().get(0).getSecUndrt().get(0).getUndrtId());
		pstmt.setDouble(4, data.getIssues().get(0).getSecurities().get(0).getSecUndrt().get(0).getTakedown());
		pstmt.executeUpdate();
	}
